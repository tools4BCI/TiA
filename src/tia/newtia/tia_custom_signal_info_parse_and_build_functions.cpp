...
//-----------------------------------------------------------------------------
SignalInfoPtr parseTiACustomSignalInfoFromXMLString (std::string const& custom_signal_info_str, const SignalInfo &default_signal_info)
{
    SignalInfoPtr custom_signal_info (new SignalInfo());
