...
//-----------------------------------------------------------------------------
CustomSignalInfoPtr TiAClient::getConfigAsCustomConfig() const
{
    return impl_->getConfigAsCustomConfig();
}

//-----------------------------------------------------------------------------

bool TiAClient::trySetCustomSignalInfo(tia::CustomSignalInfoPtr custom_sig_info, std::string &error_msg)
{
